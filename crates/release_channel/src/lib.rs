...
impl ReleaseChannel {
    ...
    pub fn display_name(&self) -> &'static str {
        match self {
            ReleaseChannel::Dev => "Lattice",
            ReleaseChannel::Nightly => "Lattice Nightly",
            ReleaseChannel::Preview => "Lattice Preview",
            ReleaseChannel::Stable => "Lattice",
        }
    }
    ...
    pub fn app_id(&self) -> &'static str {
        match self {
            ReleaseChannel::Dev => "dev.lattice.Lattice-Dev",
            ReleaseChannel::Nightly => "dev.lattice.Lattice-Nightly",
            ReleaseChannel::Preview => "dev.lattice.Lattice-Preview",
            ReleaseChannel::Stable => "dev.lattice.Lattice",
        }
    }
